    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.my_shop:
                ...
                myAccountText.setTextColor (getResources().getColor( R.color.deep_gray ));
                replaceFragment(new MyShopFragment());
                break;
            case R.id.my_account:
                myAccountText.setTextColor (getResources().getColor(R.color.orange));
                myShopText.setTextColor(getResources().getColor(R.color.deep_gray));
